...
*/
public enum PM3D_IMPL_MODE
{
	PM3D_EXPLICIT(0),
	PM3D_IMPLICIT(1);

	private int intValue;
	private static java.util.HashMap<Integer, PM3D_IMPL_MODE> mappings;
	private static java.util.HashMap<Integer, PM3D_IMPL_MODE> getMappings()
	{
		if (mappings == null)
		{
			synchronized (PM3D_IMPL_MODE.class)
			{
				if (mappings == null)
				{
					mappings = new java.util.HashMap<Integer, PM3D_IMPL_MODE>();
				}
			}
		}
		return mappings;
	...
	private PM3D_IMPL_MODE(int value)
	{
		intValue = value;
		PM3D_IMPL_MODE.getMappings().put(value, this);
	}
	...
	public static PM3D_IMPL_MODE forValue(int value)
	{
